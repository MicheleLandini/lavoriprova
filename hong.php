...
<div class="row">
<img class="col-md-9" src="style/hongkong.jpg" class="img-thumbnail" alt="...">
...
<div class="row">
<div class="col-md-12 text-center" style="background-color: lightskyblue;font-family: Verdana, Geneva, Tahoma, sans-serif" >Hong Kong 750$</div>
</div>
...
<script>
        ...
        cuba.addEventListener('click', function () {
            ...
            tr.innerHTML = '1 bigglietto per Hong Kong  '
            menu.appendChild(tr)
            tr.style.backgroundColor = 'burlywood'
            tr.style.textalign = 'center'
            tr.style.color = 'white'
            tr.style.fontWeight = 'bold'
            listaDellaSpesa.cuba+=750
